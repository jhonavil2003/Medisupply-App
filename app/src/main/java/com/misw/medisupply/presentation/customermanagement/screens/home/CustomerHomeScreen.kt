        ...
        Column(
            ...
            Text(
                text = localizedStringResource(
                    R.string.customer_home_welcome,
            ...
            Text(
                text = localizedStringResource(
                    R.string.customer_home_subtitle,
                    viewModel.localeManager
                ),
            ...
            Text(
                text = localizedStringResource(
                    R.string.customer_home_instructions,
                    viewModel.localeManager
                ),
            ...
            Column(
                ...
                Text(
                    text = localizedStringResource(
                        R.string.customer_home_shop_feature,
                        viewModel.localeManager
                    ),
                ...
                Text(
                    text = localizedStringResource(
                        R.string.customer_home_orders_feature,
                        viewModel.localeManager
                    ),
                    style = MaterialTheme.typography.bodyMedium,
                    color = MaterialTheme.colorScheme.onSurfaceVariant
                ...
                Text(
                    text = localizedStringResource(
                        R.string.customer_home_account_feature,
                        viewModel.localeManager
                    ),
                    style = MaterialTheme.typography.bodyMedium,
                    color = MaterialTheme.colorScheme.onSurfaceVariant
